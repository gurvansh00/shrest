...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            elbowR = [landmarks[mp_pose.PoseLandmark.RIGHT_SHOULER.value].x,landmarks[mp_pose.PoseLandmark.RIGHT_ELBOW.value].y]
            ...
            # Calculate angle
            angle1 = calculate_angle1(elbowL, shoulderL, hipL)
            angle2 = calculate_angle2(elbowR, shoulderR, hipR)
            print('left angle shoulder',angle1)
            print('right angle shoulder',angle2)
